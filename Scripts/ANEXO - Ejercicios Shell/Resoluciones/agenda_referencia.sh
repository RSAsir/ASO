#!/bin/bash
# (EXTRAIDO DE: http://barrapunto.com/journal.pl?op=display&id=13793&uid=15478 PARA REFERENCIA)
...
5)clear
    echo INFORMACION
    echo La base de datos contiene `cat agenda.txt | wc -l` lineas y tiene un tama&#241;o de `ls -sh -c1 | grep agenda.txt | cut -f 1 -d " "`
;;
